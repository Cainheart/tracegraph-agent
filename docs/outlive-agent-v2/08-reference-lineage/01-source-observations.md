...
| 项目 | 重点 | 对 Outlive 的假设 |
|---|---|---|
| DeepSeek Harness | package groups、composition、AGENTS/Notes/Skills、benchmarks/snapshots/Desktop | 大工程治理和能力家族可迁移，但包数量不可照抄 |
...
| TraceGraph | ledger、receipt、projection、local-first、现有 tests/evals | 是迁移基础，不是待替换的“旧 Demo” |
